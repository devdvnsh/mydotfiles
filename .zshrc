...
export ESLINT_GLOBAL_CONFIG="$HOME/.eslintrc.js"
export PATH="$PATH:$(npm bin -g)"
# export HYPRSHOT_DIR=~/Pictures/screenshots
export PATH="$PATH:/home/dev/.npm-global/bin"

# fzf
# Set up fzf key bindings and fuzzy completion

alias inv='nvim $(fzf -m --preview="bat --color=always {}")'
alias cdfzf='cd $(fzf -m --preview="bat --color=always {}")'
...
source <(fzf --zsh)
# called from scripts
alias old='~/scripts/fzf_listoldiles.sh'
...
alias tmux-notes='bat /home/dev/cheatsheets/tmux.md'
alias yazi-notes='bat /home/dev/cheatsheets/yazi.md'
